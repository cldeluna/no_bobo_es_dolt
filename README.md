 ...
 - **Python workflow (manage the Dolt database with a script)**
   ...
   This guide walks you through using `dolt_manage.py` (optionally with `uv`) to load/modify data from CSV, generate commits, and demonstrate recovery with Dolt revision control.
